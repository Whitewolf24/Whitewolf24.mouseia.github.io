...
function alive(){
  $("#epik").animate({'top': '-=184px', 'left':'+=50px','height':'-=32px', 'width':'-=32px'},'medium') ;
  $("#moyseia").animate({'top': '-=178px', 'right':'+=130px','height':'-=27px', 'width':'-=27px'},'medium');
  $("#sylog").animate({'top': '-=178px', 'left':'+=95px','height':'-=27px', 'width':'-=27px'},'medium');
  $("#lesvos").animate({'top': '-=178px', 'right':'+=75px','height':'-=27px', 'width':'-=27px'},'medium');
  
  $("#text").animate({'font-size': '21px', 'top': '-=175px', 'right':'+=80px'},'medium') ;
